...
```
# Output:
<img width="386" height="128" alt="image" src="https://github.com/user-attachments/assets/ec767cae-daf3-4c99-a74b-4eb36fc8f02b" />
...
int main() { 
    ...
    for (i = 0; i < m; i++) {
        ...
        // Find the maximum element in that same column
        for (k = 1; k < m; k++) {
            if (a[k][j] > max) {
                max = a[k][j];
                pos[1][0] = k;
...
```
# Output:
<img width="398" height="191" alt="image" src="https://github.com/user-attachments/assets/c4672eac-23c6-4733-b49b-812a3fd3e61d" />
...
```
# Output:
<img width="340" height="142" alt="image" src="https://github.com/user-attachments/assets/5082d4df-539f-4f39-aa2b-67d1e0609d37" />
...
```
# Output:
<img width="155" height="275" alt="image" src="https://github.com/user-attachments/assets/c893de54-cb2f-490d-9fad-b40f1d52ac7e" />
...
```
# Output:
<img width="296" height="176" alt="image" src="https://github.com/user-attachments/assets/5cc3d90a-2edf-4c58-8b3f-933f1ca60b53" />
